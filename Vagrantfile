Vagrant.configure(2) do |config|
  ...
  config.vm.define "ldap" do |config|
    config.vm.hostname = "ldap.andrew.cmu.edu"
  ...
  config.vm.define "sp" do |config|
    config.vm.hostname = "sp.andrew.cmu.edu"
    ...
    config.vm.provision "metadata-idp",  type: "shell", path: "sp/metadata.sh", args: "+ idp  https://idp.andrew.cmu.edu/idp/shibboleth"
    config.vm.provision "metadata-idp3", type: "shell", path: "sp/metadata.sh", args: "+ idp3 https://idp3.andrew.cmu.edu/idp/shibboleth"
  end
    
  config.vm.define "idp", autostart: false do |config|
    config.vm.hostname = "idp.andrew.cmu.edu"
  ...
  config.vm.define "idp3" do |config|
    config.vm.hostname = "idp3.andrew.cmu.edu"
  ...
  config.vm.define "drupal" do |config|
    ...
    config.vm.hostname = "drupal.andrew.cmu.edu"
    ...
    config.vm.provision "metadata-idp",  type: "shell", path: "drupal/metadata.sh", args: "+ idp  https://idp.andrew.cmu.edu/idp/shibboleth"
    config.vm.provision "metadata-idp3", type: "shell", path: "drupal/metadata.sh", args: "+ idp3 https://idp3.andrew.cmu.edu/idp/shibboleth"
